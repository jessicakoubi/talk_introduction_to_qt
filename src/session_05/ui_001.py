...
# Style information for the slider and curve widgets.
_SLIDER_BORDER_CO = QtGui.QColor(46, 46, 46)
_SLIDER_LOW_CO = QtGui.QColor(94, 185, 115)
_SLIDER_HIGH_CO = QtGui.QColor(185, 94, 94)
_SLIDER_BG_BRUSH = QtGui.QBrush(QtGui.QColor(57, 57, 57))
_SLIDER_HANDLE_RUSH = QtGui.QBrush(QtGui.QColor(101, 101, 101))

_CURVE_RAW_PT_PEN = QtGui.QPen(QtGui.QColor(0, 205, 207, 100), 1, QtCore.Qt.DashLine)
_CURVE_RAW_PT_BRUSH = QtGui.QBrush(QtGui.QColor(0, 205, 207, 50))
_CURVE_RAW_LINE_PEN = QtGui.QPen(QtGui.QColor(43, 120, 224, 160), 1, QtCore.Qt.DashLine)

_CURVE_SM_PT_PEN = QtGui.QPen(QtGui.QColor(229, 1, 1, 255), 1, QtCore.Qt.DashLine)
_CURVE_SM_PT_BRUSH = QtGui.QBrush(QtGui.QColor(210, 35, 0, 255))
_CURVE_SM_LINE_PEN = QtGui.QPen(
...
class QCurveIntensitySlider(QtWidgets.QSlider):
    ...
    def paintEvent(self, event):
        ...
        pen.setColor(_SLIDER_BORDER_CO)
        painter.setPen(pen)
        ...
        grad.setColorAt(0.0, _SLIDER_LOW_CO)
        grad.setColorAt(1.0, _SLIDER_HIGH_CO)
        ...
        painter.setBrush(_SLIDER_BG_BRUSH)
        painter.drawRect(bg_rect)
        ...
        painter.setBrush(_SLIDER_HANDLE_RUSH)
